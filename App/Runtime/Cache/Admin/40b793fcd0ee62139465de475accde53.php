		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					<form class="form-horizontal" action="<?php echo U('Community/insert');?>" method="post"  enctype="multipart/form-data" >
						<fieldset>
							<div class="control-group">
								<label class="control-label" for="typeahead">邀请码</label>
								<div class="controls">
									<input type="text" name="propertyid" class="span6 typeahead"></div>
							</div>
							<div class="control-group">
								<label class="control-label" for="typeahead">账号</label>
								<div class="controls">
									<input type="text" name="tel" class="span6 typeahead"></div>
							</div>
							<div class="control-group">
								<label class="control-label" for="typeahead">密码</label>
								<div class="controls">
									<input type="text" name="password" class="span6 typeahead"></div>
							</div>
