			...
			<ul>
				<li>
					<a class="submenu" href="<?php echo U('Estate/index');?>">
						<i class="icon-file-alt"></i>
						<span class="hidden-tablet">小区列表</span>
					</a>
				</li>
				<li>
				...
				<li>
					<a class="submenu" href="<?php echo U('Estate/add');?>">
						<i class="icon-file-alt"></i>
						<span class="hidden-tablet">添加小区</span>
					</a>
				</li>
			</ul>
		</li>
...
<script src='/wgyttp/Publicjs/fullcalendar.min.js'></script>

<script src='/wgyttp/Publicjs/jquery.dataTables.min.js'></script>
