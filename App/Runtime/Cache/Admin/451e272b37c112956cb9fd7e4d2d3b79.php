					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"> <i class="icon-align-justify icon-folder-close-alt"></i>
								<span class="hidden-tablet">物业小区管理</span>
								<!-- <span class="label label-important">3</span> -->
							</a>
							<ul>
								<li><a class="submenu" href="index.html"><i class="icon-file-alt"></i><span class="hidden-tablet">物业管理</span></a></li>
								<li><a class="submenu" href="insert.hmtl"><i class="icon-file-alt"></i><span class="hidden-tablet">添加小区管理员</span></a></li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>添加小区管理</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">物业编号 </label>
							  <div class="controls">
