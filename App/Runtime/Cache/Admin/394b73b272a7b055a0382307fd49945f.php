			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>修改小区信息</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo U('Community/update');?>" method="post"  enctype="multipart/form-data" >
						<input type="hidden" value="<?php echo ($user['id']); ?>" name="id" />
						<fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">邀请码 </label>
							  <div class="controls">
								<input type="text" name="propertyid" value="<?php echo ($user['propertyid']); ?>" class="span6 typeahead">
							  </div>
						  	</div>
						  	<div class="control-group">
							  <label class="control-label" for="typeahead">账号 </label>
							  <div class="controls">
								<input type="text" name="tel" value="<?php echo ($user['tel']); ?>" class="span6 typeahead">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">密码 </label>
							  <div class="controls">
								<input type="text" name="password" value="<?php echo ($user['password']); ?>" class="span6 typeahead">
							  </div>
							</div>
