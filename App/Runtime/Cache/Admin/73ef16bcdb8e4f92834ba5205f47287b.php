			...
			<div class="box span12">
				...
				<div class="box-content">
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						<a class="btn btn-success" href="<?php echo U('Estate/add');?>">添加小区</a>
						<br />
						<br />
						<thead>
							<tr>
						...
						<tbody>
							<?php if(is_array($estates)): foreach($estates as $key=>$estate): ?><tr>
									...
									<td class="center">
										<img src="/wgyttp/Public/Admin/Uploads/<?php echo ($estate["img1"]); ?>" height="80" width="80"></td>
									<td class="center">
										<img src="/wgyttp/Public/Admin/Uploads/<?php echo ($estate["img2"]); ?>" height="80" width="80"></td>
									<td class="center">
										<img src="/wgyttp/Public/Admin/Uploads/<?php echo ($estate["img3"]); ?>" height="80" width="80"></td>
									<!-- <td class="center">
								...
								<td class="center">
									...
									<!-- <a class="green" href="/wgyttp/index.php/Admin/Estate/modify/id/<?php echo ($estate['id']); ?>">
									-->
									<a class="btn btn-info" href="/wgyttp/index.php/Admin/Estate/modify/id/<?php echo ($estate["id"]); ?>">修改</a>
									<a class="btn btn-danger" href="/wgyttp/index.php/Admin/Estate/del/id/<?php echo ($estate["id"]); ?>">删除</a>
								</td>
