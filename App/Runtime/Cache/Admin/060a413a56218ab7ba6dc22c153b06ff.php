		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					...
					-->
					<a class="btn btn-success" href="/wgyttp/index.php/Admin/Community/add">添加账号</a>
					<br />
					<br />
					<thead>
						<tr>
					...
					<tbody>
						<?php if(is_array($communitys)): foreach($communitys as $key=>$community): ?><tr>
								...
								<td class="center">
									...
									<!-- <a class="green" href="/wgyttp/index.php/Admin/Community/modify/id/<?php echo ($estate['id']); ?>">
									-->
									<a class="btn btn-info" href="/wgyttp/index.php/Admin/Community/modify/id/<?php echo ($community["id"]); ?>">
										修改
										<!-- <i class="halflings-icon white edit"></i>
									-->
								</a>
								<a class="btn btn-danger" href="/wgyttp/index.php/Admin/Community/del/id/<?php echo ($community["id"]); ?>">
									删除
