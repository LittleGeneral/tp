	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo U('Index/index');?>"><span>物管云台后台管理</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo U('Login/login');?>"><i class="halflings-icon off"></i> 退出</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?php echo U('Index/index');?>"><i class="icon-bar-chart"></i><span class="hidden-tablet">控制台</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo U('Index/index');?>"><i class="icon-file-alt"></i><span class="hidden-tablet">小区管理</span></a></li>
						...
						<li><a href="<?php echo U('Login/login');?>"><i class="icon-lock"></i><span class="hidden-tablet"> 登录</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
